...
const initThreeScene = () => {
  ...
  const sectionConfigsV1 = [
    ...
    { id: "v1-ch2", z: 5.28, y: -0.18, x: 0.18 },
    { id: "v1-ch3", z: 5.06, y: 0.46, x: -0.16 },
    { id: "v1-ch-comp", z: 4.84, y: -0.12, x: 0.16 },
  ...
  const mobileSectionConfigsV1 = [
    ...
    { id: "v1-ch2", z: 5.95, y: -0.26, x: 0.12 },
    { id: "v1-ch3", z: 5.72, y: 0.76, x: -0.12 },
    { id: "v1-ch-comp", z: 5.5, y: -0.22, x: 0.1 },
